# Changelog — Archive (v0.x–v2.x)

> Historical entries preserved from the main `CHANGELOG.md`.
> Wording is kept as originally written (including legacy path references like `.ai-backlog/` and `.ai/skill/`).
> For current (3.x) releases, see [../CHANGELOG.md](../CHANGELOG.md).
